...
?>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-10 offset-lg-1">
						<img class="specialists__img" src=<?php the_field('team_img')?>>
					</img>
				</div>
			</div>
		</div>
		...
		<div class="contacts" id="contacts">
			<h1 class="title"><?php the_field('address_title')?></h1>
			<div class="container">
				<div class="row">
					<div class="col-lg-6">
						<div class="contacts__descr underlined">
							<?php the_field('address_descr')?>
						</div>
					</div>
					<div class="col-lg-6">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="title contacts__minititle"><?php the_field('address_subtitle_2')?></div>
					...
					<div class="col-md-6">
						...
						<div class="contacts__feed">
							<?php  echo do_shortcode('[contact-form-7 id="4e7e0a0" title="Форма отзывов"]')?>
